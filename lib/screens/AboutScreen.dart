                ...
                children: <Widget>[
                  if (widget.settingModel.instagramUrl != null &&
                    ...
                    inkWellWidget(
                      ...
                      child: Container(
                        ...
                        child:
                            Image.asset(ic_insta_logo, height: 28, width: 28),
                      ),
                    ),
                  if (widget.settingModel.twitterUrl != null &&
                    ...
                    inkWellWidget(
                      ...
                      child: Container(
                        padding: EdgeInsets.all(10),
                        child:
                            Image.asset(ic_twitter_logo, height: 28, width: 28),
                      ),
                    ),
                  if (widget.settingModel.linkedinUrl != null &&
                    ...
                    inkWellWidget(
                      ...
                      child: Container(
                        padding: EdgeInsets.all(10),
                        child:
                            Image.asset(ic_linked_logo, height: 28, width: 28),
                      ),
                    ),
                  if (widget.settingModel.facebookUrl != null &&
                    ...
                    inkWellWidget(
                      ...
                      child: Container(
                        padding: EdgeInsets.all(10),
                        child: Image.asset(ic_facebook_logo,
                            height: 28, width: 28),
                      ),
                    ),
                    ...
                    inkWellWidget(
                      onTap: () {
                        if (widget.settingModel.contactNumber != null &&
                          ...
                          launchUrl(
                              Uri.parse(
                                  'tel:${widget.settingModel.contactNumber}'),
                              mode: LaunchMode.externalApplication);
                        } else {
                          toast(language.txtURLEmpty);
                        }
