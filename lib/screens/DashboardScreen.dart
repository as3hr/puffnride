...
import 'package:oncab/screens/ChatScreen.dart';
import 'package:oncab/screens/DetailScreen.dart';
import 'package:oncab/screens/ReviewScreen.dart';
...
import 'package:oncab/screens/RideDetailScreen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  mqttForUser() async {
    ...
    try {
      debugPrint("rehman");
      await client.connect('package:oncab_driver', '0nC@b_Driv3r');
                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                        'images/Ellipse 143.svg'), // Replace with your image URL
                  ),
                  Row(
                    children: [
                      // Settings Icon
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  minimumSize: Size(double.infinity,
                                      50), // Full width with a defined height
                                ),
                                child: Container(
                                  alignment: Alignment
                                      .center, // Center the button text
                                  width: MediaQuery.of(context).size.width *
                                      0.97, // Set width to 97% of the screen
                                  child: Text(
                                    "View Ride",
                                    style: TextStyle(
                                      color: Colors.white,
